<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatSet.aspx.cs" Inherits="CatSet" %>
...
<form id="form1" runat="server">
   <table>
    ...
    <div>
     <table>
        <tr>
            ...
            <td>
                <asp:Label ID="lblCatId" runat="server" Visible="false"></asp:Label>&nbsp;</td>
        </tr>
        <tr>
    ...
    <div style="padding: 10px; margin: 0px; width: 100%;">
        ...
        <asp:GridView ID="GridViewStudent" runat="server" DataKeyNames="CatId" 
