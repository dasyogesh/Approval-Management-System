<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatSetAlt.aspx.cs" Inherits="CatSetAlt" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CATEGORY MASTER SETTINGS</title>
...
<body>
     <h2>CATEGORY MASTER SETTINGS</h2>
...
<asp:TextBox ID="isActive" runat="server" Text='<%# Bind("isActive") %>' />
    ...
    <br />
    <br />
    <a href="Admin1.aspx">HOME PAGE</a> &nbsp &nbsp <a href="Admin2.aspx">ADMIN PAGE</a> &nbsp &nbsp <a href="CatSetAlt.aspx">USER MASTER SETTINGS:HOME PAGE</a>
