<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubCatSet.aspx.cs" Inherits="SubCatSet" %>
...
<form id="form1" runat="server">
   <table>
        ...
        <h2>SUB CATEGORY MASTER SETTINGS</h2>
    <div>
     <table>
        <tr>
            <td class="td">Name:</td>
            ...
            <td>
                <asp:Label ID="lblSubCatId" runat="server" Visible="false"></asp:Label>&nbsp;</td>
        </tr>
        <tr>
    ...
    <div style="padding: 10px; margin: 0px; width: 100%;">
        ...
        <asp:GridView ID="GridViewStudent" runat="server" DataKeyNames="SubCatId" 
